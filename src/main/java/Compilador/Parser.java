...
case 1:
//#line 15 "gramatica.y"
{if(!GeneradorCodigoIntermedio.BaulDeGoto.isEmpty()){cargarErrorEImprimirlo(" Error: No se cargo la direccion de salto a un GOTO. ");}}
break;
case 3:
//#line 17 "gramatica.y"
...
{if(fueDeclarado(val_peek(0).sval)){completarBifurcacionAGoto(val_peek(0).sval);GeneradorCodigoIntermedio.BaulDeGoto.remove(val_peek(0).sval);}else{cargarErrorEImprimirlo("Linea :" + AnalizadorLexico.saltoDeLinea +  " Error : La ETIQUETA que se pretende bifurcar no existe.  ");}}
break;
case 58:
